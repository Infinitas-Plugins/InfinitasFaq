...
?>
<div class="dashboard">
	<h2><?php echo __('Blog Dashboard'); ?></h2>
	<div class="info">
	...
	<div class="column-a">
		<div class="box tasks">
			<h3><?php echo __('Common Tasks'); ?></h3>
			<ul>
				<li>
		...
		<div class="box charts">
			<h3><?php echo __('Data overview'); ?></h3>
			<ul>
				<li class="first">
					...
					<?php
						echo $this->Chart->display(
							...
							array(
								...
								'labels' => array(__('Active'), __('Pending')),
								'size' => array(200, 70),
							)
						);
					?>
	...
	<div class="column-b">
		<div class="box blog-feed clr">
			<h3 class="left"><?php echo __('Recent activity'); ?></h3>
				...
				<?php
					if($blogFeeds) {
						foreach($blogFeeds as $feed) {
							...
							if ($feed['Feed']['controller'] == 'infinitas_comments') {
								$icon = 'comment';
							}
