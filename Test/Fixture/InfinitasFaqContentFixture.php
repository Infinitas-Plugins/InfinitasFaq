<?php
/**
 * @brief fixture file for InfinitasFaqContent tests.
 *
 * @package InfinitasFaq.Fixture
 * @since 0.9b1
 */
class InfinitasFaqContentFixture extends CakeTestFixture {
	public $name = 'InfinitasFaqContent';
